...
- **`/preview` is the design authority** until sign-off. See `docs/DESIGN.md` for tokens, typography (Mona Sans, Sligoil), flag palette, illustrated hero, and two-stage intake. Pass 7 (queued) upgrades that preview into a system: `docs/UI-HANDOVER.md` §16.
