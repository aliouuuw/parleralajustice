...
- **Service header:** sticky civic bar. Brand is « Sunu Justice » plus a small « démo » on citizen routes, « greffe » on `/guichet`. Citizen jobs: déposer, suivre, acte. On greffe: Espace citoyen, agent session, Quitter. Account action is « Connexion » on the citizen site.
